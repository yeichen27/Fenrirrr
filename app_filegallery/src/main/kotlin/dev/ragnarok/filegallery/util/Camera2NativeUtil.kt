...
import dev.ragnarok.fenrir.module.camerax.ImageProcessingUtilNative
...
object Camera2ImageProcessingUtil : ImageProcessingUtil_JNI {
    ...
    override fun nativeGetYUVImageVUOff(
        srcByteBufferV: ByteBuffer,
        srcByteBufferU: ByteBuffer
    ): Int {
        return ImageProcessingUtilNative.getYUVImageVUOff(srcByteBufferV, srcByteBufferU)
    }

    override fun nativeNewDirectByteBuffer(
        byteBuffer: ByteBuffer,
        offset: Int,
        capacity: Int
    ): ByteBuffer {
        return ImageProcessingUtilNative.newDirectByteBuffer(byteBuffer, offset, capacity)
    }
}
