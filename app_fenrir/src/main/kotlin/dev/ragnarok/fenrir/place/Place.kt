...
open class Place : Parcelable {
    ...
    companion object {
        ...
        const val USER_DETAILS = 63
        const val AUDIOS_IN_ALBUM = 64
        const val COMMUNITY_INFO = 65
        const val COMMUNITY_INFO_LINKS = 66
        const val SETTINGS_THEME = 67
        const val SEARCH_BY_AUDIO = 68
        const val MENTIONS = 69
        const val OWNER_ARTICLES = 70
        const val WALL_ATTACHMENTS = 71
        const val STORY_PLAYER = 72
        const val ARTIST = 73
        ...
        const val SEARCH_COMMENTS = 87
        const val SHORTCUTS = 88
        const val NARRATIVES = 89
        const val VOTERS = 90
        const val FEED_BAN = 91
        const val REMOTE_FILE_MANAGER = 92
        const val COMMUNITY_MEMBERS = 93
        const val FRIENDS_BIRTHDAYS = 94
        const val CATALOG_V2_AUDIO_CATALOG = 95
        const val CATALOG_V2_AUDIO_SECTION = 96
        const val CATALOG_V2_LIST_EDIT = 97
        const val STORIES_VIEWS = 98
        const val SHORT_VIDEOS = 99
